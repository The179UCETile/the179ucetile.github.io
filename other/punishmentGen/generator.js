...
function generatePunishment() { try {
  ...
  const Punishments = [
    ...
    [`Scroll ${utils.properNum(1e3, true)} characters in TextWall.<br>Page zooming is forbidden.`, utils.properDiff(1.2), 1.2],
    [`Survive the fictional googology punishment.`, 1.6, 1.6],
    [`Scroll ${utils.properNum(5e3, true)} characters in TextWall.<br>Page zooming is forbidden.`, utils.properDiff(3), 3],
    ...
    [`Scroll ${utils.properNum(25e3, true)} characters in TextWall.<br>Page zooming is forbidden.`, utils.properDiff(4.8), 4.8],
    [`In any game that you have experience on, complete ${utils.properNum(2, true)} levels that you consider the closest to &quot;Medium&quot; in Eternal Towers of Hell difficulty.`, utils.properDiff(2.44), 2.44],
    ...
    [`In any game that you have experience on, complete ${utils.properNum(3, true)} levels that you consider the closest to &quot;Hard&quot; in Eternal Towers of Hell difficulty.`, utils.properDiff(3.63), 3.63],
    ...
    [`Jump ${utils.properNum(10, true)} times IRL.`, utils.properDiff(1.25), 1.25],
    ...
    [`Complete ${utils.properNum(2, true)} Intense towers in Eternal Towers of Hell in ${utils.properNum(20, true)} minutes.`, utils.properDiff(7.35), 7.35],
    [`Count to ${utils.properNum(50, true)} IRL.<br>Skipping numbers is not allowed.`, utils.properDiff(1.93), 1.93],
    [`Count to ${utils.properNum(1e3, true)} IRL.<br>Skipping numbers is not allowed.`, utils.properDiff(4.26), 4.26],
    [`Count to ${utils.properNum(1e5, true)} IRL.<br>Skipping numbers is not allowed.`, utils.properDiff(6.28), 6.28],
    [`Send someone ${utils.properNum(10)} seconds of keyboard spam.`, utils.properDiff(2.2), 2.2],
    [`Count to ${utils.properNum(1e6, true)} IRL.<br>Skipping numbers is not allowed.`, utils.properDiff(7.99), 7.99],
    ...
    [`Speak in another language that you DON&apos;T how to speak for ${utils.properNum(10)} minutes.`, utils.properDiff(5.94), 5.94],
